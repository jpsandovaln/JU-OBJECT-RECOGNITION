...
## Important Notes
> the file yolov3.weights must be downloaded from official YOLO web page and must be paste in the folder /OR-YOLOImagesGradlewT/src/main/java/

> the library OpenCV will be into this specific folder, once downloaded it must be paste in the folder /OR-YOLOImagesGradlewT/src/