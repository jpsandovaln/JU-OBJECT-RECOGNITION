...
public class yoloImage {
    ...
    public yoloImage (String inputPath, String outputPath, Integer image_size, String outputFileName) {
        System.load("C:\\Program Files\\Java\\jdk-18.0.2\\lib\\opencv\\build\\java\\x64\\opencv_java454.dll");
        ...
        model_weights = current_dir + "\\yolov3.weights";
        model_config = current_dir + "\\yolov3.cfg";
        class_file_name_dir = current_dir + "\\yolov3.txt";
        save = true;
    }
    ...
    private void drawLabels() {
        ...
        if (save) {
            System.out.println("Save the image configured");
    ...
    public void loadPipeline() {
        try {
            ...
            System.out.println("job 4 done");
            loadImage();
            System.out.println("job 5 done");
            detectObject();
            System.out.println("job 6 done");
            getBoxDimensions();
            System.out.println("job 7 done");
            drawLabels();
