...
import org.example.TransformTXT.Transform;
import java.io.File;
...
public class yoloImage {
    ...
    public yoloImage (String inputPath, int ocurrencyPercentage) {
        ...
        System.load(current_dir + "\\src\\opencv\\build\\java\\x64\\opencv_java454.dll");
        ...
        model_weights = current_dir + "\\src\\main\\java\\yolov3.weights";
        model_config = current_dir + "\\src\\main\\java\\yolov3.cfg";
        class_file_name_dir = current_dir + "\\src\\main\\java\\yolov3.txt";
        save = true;
    }
